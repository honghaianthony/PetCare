      ...
      <div className="productDetail">
        ...
        <div className="productDetail-Container">
          ...
          <div className="productDetail-detail">
            ...
            <hr />
            <div className="productDetail-detail-info productDetail-detail-info1">
              <h3>Thông tin</h3>
              <table>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <td>Gửi từ</td>
                    <td>
                      KTX khu A, khu phố 6, phường Linh Trung, TP. Thủ Đức, TP.
                      Hồ Chí MInh
                    </td>
                  </tr>
                </tbody>
            ...
            <hr className="productDetail-detail-hr productDetail-detail-info1" />
            ...
            <div className="productDetail-detail-info">
              ...
              <b className="productDetail-detail-info1">
                <i>Lượng thức ăn hợp lí với từng trọng lượng cơ thể :</i>
              </b>
              <ul className="productDetail-detail-info1">
                <li>1-2kg: 15-35g</li>
                <li>2-3kg: 35-50g</li>
                <li>3-4kg: 50-65g</li>
                <li>4-5kg: 65-85g</li>
