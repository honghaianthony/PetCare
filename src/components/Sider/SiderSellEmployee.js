...
import "./Sider.css";
function SiderSellEmployee({ toggleSider, setToggleSider }) {
        ...
        <>
            ...
            <div className={`sider-container ${toggleSider ? "" : "hidden"}`}>
                ...
                <ul className="sider-body">
                    <li
                        className={
                            location.pathname === "/sellemployee/user"
                                ? "active"
                                : undefined
                        }
                    >
                        <Link to="/sellemployee/user">
                    ...
                    <li
                        className={
                            location.pathname === "/sellemployee/product"
                                ? "active"
                                : undefined
                        }
                    >
                    ...
                    <li
                        className={
                            location.pathname === "/sellemployee/order"
                                ? "active"
                                : undefined
                        }
                    >
                        <Link to="/sellemployee/order">
...
export default SiderSellEmployee;
