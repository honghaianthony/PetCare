            ...
            <div className="ProductsContent_menu_container">
              <div className="ProductsContent_menu_">
                ...
                <div className="Menu_item_content_product">
                  <div className="input_checkbox_menu">
                    <input
                      ...
                      checked={filterList.length === categories.length}
                ...
                {categories.map((item, index) => (
                  <div className="Menu_item_content_product" key={item._id}>
                    <div className="input_checkbox_menu">
                      <input
                        type="checkbox"
                        id={index}
              ...
              <div className="Sort_product_item_container">
                <div className="Sort_product_item_container_">
                  <select name="rate" id="rate" onChange={handleSort}>
                    <option value="Đánh giá" className="option_sort">
                      Đánh giá
                    </option>
                    <option value="tăng" className="option_sort">
                      Đánh giá tăng
                    </option>
                    <option value="giảm" className="option_sort">
                      Đánh giá giảm
                    </option>
                  </select>
                </div>
                <div className="Sort_product_item_container_">
                  ...
                  >
                    ...
                    <option value="lượng mua tăng" className="option_sort">
                      Lượng mua tăng
                    </option>
                    <option value="lượng mua giảm" className="option_sort">
                      Lượng mua giảm
                    </option>
                  </select>
                </div>
                <div className="Sort_product_item_container_">
                  <select name="price" id="price" onChange={handleSort}>
                    ...
                    <option value="giá tăng" className="option_sort">
                      Giá tăng
                    </option>
                    <option value="giá giảm" className="option_sort">
                      Giá giảm
                    </option>
                  </select>
                </div>
