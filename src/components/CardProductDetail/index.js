...
const CardProductDetail = (props) => {
  ...
  return (
    <>
      <Link className=" card__product__container__" to={`/product/${props.id}`}>
      ...
      <Link className=" card__product__container__second" to={`/product/${props.id}`}>
        ...
        <div className="Review_Buy_Product_container_second">
          <NavLink className="quick_view_button_second" to={`/product/${props.id}`}>
            {/* <button className="quick_view_button_"> */}
            <span className="quick_view_text">Xem nhanh</span>
            <Icon icon="emojione-monotone:eye" color="white" className="icon_quick_view" />
            {/* </button> */}
          </NavLink>
          <NavLink className="add_to_cart_button_second" to={`/product/${props.id}`}>
            {/* <button className="add_to_cart_button"> */}
            <span className="add_to_cart_text" >Mua ngay</span>
            <Icon icon="el:shopping-cart" color="white" className="add_to_cart_icon" />
            {/* </button> */}
