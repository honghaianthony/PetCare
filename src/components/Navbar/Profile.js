            ...
            <>
              <div className="profile-option-detail">
                <Icon
                  ...
                  className="profile-option-detail-icon"
                />
                <Link to="/admin/statistical">Trang quản trị</Link>
              </div>
            </>
          )}
          <div className="profile-option-detail" onClick={handleLogout}>
            <Icon icon="fe:logout" className="profile-option-detail-icon" />
            <p> Đăng xuất </p>
          </div>
        </div>
      </div>
